...
class Galaxia(tk.Toplevel):
    def __init__(self, parent, *args, **kwargs):
        ...
        titulo = " Geografia - Las Galaxias"

        introduccion = """
El inmenso mar negro del universo, millones de estrellas se concentran formando grandes aglomeraciones o sistemas a los que conocemos como galaxias.
        """

        texto2 = """
Actualmente se han encontrado 2 billones de galaxias en el universo visible, todo eso fue posible con ayuda de enormes telecopios, fotografias de alta potencia y computadoras.
        """
        # imagen 

        texto3 = """
La variedad de galaxias tienen formas irregulares y elipticas. 
        """
        
        texto4 = """
Seguramente te habras dado cuenta en los caracteristicos brazos que estas poseen, lo que en realidad son, en el ambito cientifico son conocidos como \"Campos Magneticos\". En una galaxia como la M51 se pueden observar los brazos espirales ópticos.
        """
