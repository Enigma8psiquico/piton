...
class ViaLactea(tk.Toplevel):
    def __init__(self, parent, *args, **kwargs):
        ...
        titulo = " Geografia / La Via Lactea"

        introduccion = """
La galaxia en la que forma parte el Sol se llama Vía Lactea.
        """

        texto2 = """
En la Vía Lactea se ha encontrado al rededor de 200 millones de estrellas incluyendo al Sol.
        """

        texto3 = """
Actualmente ya no es posible ver el firmamento de la noche; pero ase muchos años era posible contemplar almenos unaa pequeñisima parte de estrellas.
        """
        
        texto4 = """
La unidad de medida para determinar la distancia es en \"años luz\", que es el espacio que recorre la distancia en un año.
Tomando en cuenta que no hay nada mas rapido en el Universo que la luz, el cual equivale 300 mil kilometros por segundo. Un promedio de 7 años luz que separa a las estrellas.
        """

        texto5 = """
El sol se encuentra en uno de los brazos espirales externos de vía lactea y la distancia entre el sol y el centro de la vía lactea es de 32 mil años luz.
        """
        ...
        self.labeltexto4 = tk.Label(self.canvas, text = texto4, font = ("Cascadia Code", 12, "bold"), wraplength = 450, justify = tk.LEFT)
            # texto 5
        self.labeltexto5 = tk.Label(self.canvas, text = texto5, font = ("Cascadia Code", 12, "bold"), wraplength = 450, justify = tk.LEFT)


        # llamado de labeles 
        self.canvas.create_window(0,0, window = self.labelTitulo)
        self.canvas.create_window(10,100, window = self.labelintroduccion)
        self.canvas.create_window(310, 300, window = self.labeltexto2)
        self.canvas.create_window(10,488, window = self.labeltexto3)
        self.canvas.create_window(310, 700, window = self.labeltexto4)
        self.canvas.create_window(10,1000, window = self.labeltexto5)
