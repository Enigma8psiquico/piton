...
class pag5(tk.Toplevel):
    def __init__(self, parent, *args, **kwargs):
        ...
        tk.Button(self.barraSuperior, text="Inicio", command=self.volver, 
        	compound = tk.LEFT, image = self.imagenBoton, 
        	font = ("Bauhaus 93", 21, "bold")).place(x = 10, y =0)
